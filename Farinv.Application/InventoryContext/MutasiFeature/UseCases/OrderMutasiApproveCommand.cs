...
public class OrderMutasiApproveHandler
    : IRequestHandler<OrderMutasiApproveCommand>
{
    ...
    public Task Handle(
        OrderMutasiApproveCommand request,
    ...
    private OrderMutasiModel GetOrderMutasi(IOrderMutasiKey key)
    {
