    ...
    string fs_stok_layer_id)
{
    public StokBukuType ToModel()
    {
        ...
        var result = new StokBukuType(fs_kd_trs, 0, trsReff, fs_kd_jenis_mutasi,
            (int)fn_stok_in, (int)fn_stok_out, trsReffDateTime, ModelStateEnum.Unchange);
        return result;
    }
};